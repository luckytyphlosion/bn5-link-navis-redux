...
# Make patches
mkdir -p "out_patch/bn5_gate_redux/v1.1.0"
./tools/floating/flips.exe -c -b "bn5p.gba" "bn5p-link-navis-redux.gba" "out_patch/bn5_gate_redux/v1.1.0/BRBE_00.bps"
./tools/floating/flips.exe -c -b "bn5c.gba" "bn5c-link-navis-redux.gba" "out_patch/bn5_gate_redux/v1.1.0/BRKE_00.bps"
